...
public class RefugiGetRefugisRefugiUbicacio {
	...
	@JsonProperty("latitud")
	public RefugiGetRefugisRefugiUbicacio setLatitud(String latitud) {
	...
	@JsonProperty("longitud")
	public RefugiGetRefugisRefugiUbicacio setLongitud(String longitud) {
	...
	@JsonProperty("comentaris")
	public RefugiGetRefugisRefugiUbicacio setComentaris(String comentaris) {
	...
	@JsonProperty("Altitud")
	public RefugiGetRefugisRefugiUbicacio setAltitud(String altitud) {
		Altitud = altitud;
		return this;
	}
